events.on('init', types.model.giveTypes, 'typesGived')
events.on('typesGived', types.view.loadTypes, 'typesLoaded')
events.on('typesLoaded', types.view.listenTypes, 'typeClicked')
events.on('typeClicked', types.model.setType, 'typeDone')

events.on('typeDone', (type) => console.log(type))
